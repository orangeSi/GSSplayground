...
perl ../prepare.data.pl --list list5 --prefix out9 --outdir . --conf main.12.conf
...
perl ../plot.genome.featureCluster.pl --list list5.ytick --prefix out12 --outdir . --conf main.12.conf
