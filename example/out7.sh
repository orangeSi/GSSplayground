...
cat s4.hist_scatter_line.setting.conf  s2.synteny.setting.conf s1.synteny.setting.conf s4.synteny.setting.conf s3.synteny.setting.conf >feature.color.label.conf7
