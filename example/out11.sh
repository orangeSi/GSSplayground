...
cat chr14.plot_depth.setting.conf chr14.read_mapping.setting.conf  feature.color.label.conf11 >  feature.color.label.conf11.new
#cat chr14.plot_depth.setting.conf  feature.color.label.conf11 >  feature.color.label.conf11.new
